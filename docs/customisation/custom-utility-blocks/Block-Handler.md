...
Block handler implementation for custom utility blocks.

## Overview

Block Handler encompasses various features and capabilities that help you:
...
Block Handler can be configured through:
