...
Data Store provides persistent key-value data storage for long-term data retention.

## Overview

Data Store encompasses various features and capabilities that help you:
...
Data Store can be configured through:
