...
You should be aware that in a **Level 1** cluster, if the server that fails is running the databases and Redis, then this will bring the system down. If high availability is important then you should use a **Level 2** cluster.
