...
- Hard code any field by entering the value in `"your value"` (use double quotes). You can see this in the above screenshot for the Recipient field `"info@ziggyservices.com"`.  
